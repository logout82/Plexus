...
/** Utility functions used by the Plexus Qt UI.
 */
namespace GUIUtil
{
...
// Render Plexus addresses in monospace font
...
// Parse "plexus:" URI into recipient object, return true on successful parsing
